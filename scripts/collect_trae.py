...
def build_insights(sessions):
    ...
    if total_sessions:
        patterns.append({
            "title": f"Trae 在{'自主执行' if agent_count >= chat_count else '辅助问答'}角色上已经稳定",
